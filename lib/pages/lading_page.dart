        ...
        children: [
          ...
          Container(
            ...
            child: Text("Welcome Back",
              ...
              style: AppStyles.h3.copyWith(color: AppColor.buttonColorPrimary, fontWeight: FontWeight.bold),
            ),
          ),
                ...
                children: [
                  ...
                  IconButton(onPressed: (){
                    setState(() {
                      ...
                      color: Colors.blue,
                      icon: Icon(_showPasword?Icons.visibility_off_outlined:Icons.visibility))
                ],
              ),
            ),
          ),
          Expanded(
              child: RawMaterialButton(
                onPressed: (){
                 checkLogin(emailControler.value.text,passwordControler.value.text);
            ...
            child: Container(
              ...
              child: RichText(
                text:  TextSpan(children: [
                  const TextSpan(text: "Bạn chưa có tài khoảng? ",
                      style: TextStyle(color: AppColor.textColor)
                  ),
                  TextSpan(text: "Đăng Kí Tại Đây",
